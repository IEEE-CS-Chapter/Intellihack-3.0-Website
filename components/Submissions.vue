<template>
    <section id="submissions">
        ...
        <a class="text-2xl  text-[var(--color-brand-blue)]">
            Proposal submissions here
            <Icon name="eva:external-link-fill" />
        </a>
        <a class="text-2xl  text-[var(--color-brand-blue)]">
            Booklet here
            <Icon name="eva:external-link-fill" />
        ...
        <Transition name="form" mode="out-in">
            <KeepAlive>
                <div class="form__block" v-if="activeFormBlock === 1">
                    ...
                    <BaseInput required label="Team Name" v-model="formData.teamName" label-for="teamName" id="teamName" />
